...
// Default starting brightness of the two channels.  The cool white LEDs on
// channel 1 are more efficient than the warm white ones, so we run them at a
// lower duty cycle.
#define DEFAULT_PWM_CHANNEL0 0x0500
#define DEFAULT_PWM_CHANNEL1 0x0300
